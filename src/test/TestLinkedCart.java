...
public class TestLinkedCart {
	...
	private static double testRemove() {
		...
		LinkedCart linkedCart = new LinkedCart();
		ClothingItem item = new ClothingItem("Shirt", 19.99, 'M');
		ClothingItem item2 = new ClothingItem("Shirt", 19.99, 'S');
		ClothingItem item3 = new ClothingItem("Shirt", 19.99, 'L');
		linkedCart.insert(0, new CartItem(item, 1));
		linkedCart.insert(1, new CartItem(item2, 2));
		linkedCart.insert(1, new CartItem(item3, 2));
		linkedCart.remove(0);
		if (linkedCart.size() == 2 && linkedCart.find("Shirt", 'L') == 0) {
